...
echo "\nDownloading video ${VIMEO_ID} to ${FILENAME_CAPTION}...\nRequest_signature=${REQUEST_SIGNATURE}\nRequest_signature_expires=${REQUEST_SIGNATURE_EXPIRES}\n"
${GET_CMD} "http://www.vimeo.com/moogaloop/play/clip:${VIMEO_ID}/${REQUEST_SIGNATURE}/${REQUEST_SIGNATURE_EXPIRES}/?q=${ISHD}" > "/Users/donie/Downloads/${FILENAME_CAPTION}"
echo "Video ${VIMEO_ID} saved to ${FILENAME_CAPTION}"
echo `file "${FILENAME_CAPTION}"`
#echo `copy to caption file name "${CAPTION}.flv"`
#cp "${FILENAME}" "${CAPTION}.flv"
echo
